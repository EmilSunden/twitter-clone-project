...
import { ReplyDialogProps } from "types/types";
...
const ReplyDialog = ({ tweet, repliesCount }: ReplyDialogProps) => {
  ...
  return (
    <Dialog onOpenChange={setIsReplyDialogOpen} open={isReplyDialogOpen}>
      <DialogTrigger className="rounded-full text-white  space-x-2 flex items-center hover:bg-white/10 transition duration-200 cursor-pointer p-2">
        <BsChat />
